...
$\PARTY{T}$: 
it will act to randomise one element of the state matrix used by AES, at 
a chosen point during the associated encryption.
...
\item $\FAULT$, 
      a  fault specification
                                                                     (the format and semantics of this field are explained further below),
      and
\item $\PUB{m}$,
